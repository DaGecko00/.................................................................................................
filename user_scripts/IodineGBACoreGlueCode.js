...
var games = {
    ...
    "tgr":"Top Gear Rally",
    "tt":"Teen Titans",
    "dm":"Duel Masters - Sempai Legends",
    ...
    "tkf":"1073 - The King of Fighters EX2",
...
function downloadBIOS() {
    downloadFile("Binaries/GBA/gba_bios.bin", registerBIOS);
}
...
function downloadROM(gamename) {
    ...
    downloadFile("Binaries/GBA/" + gamename + ".gba", registerROM);
}
